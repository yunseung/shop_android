...
import kotlinx.android.synthetic.main.view_holder_ban_sld_rounded_s_item.view.*

class BanSldRoundedSItem : ConstraintLayout {
    ...
    private fun initLayout() {
        ...
        inflater.inflate(R.layout.view_holder_ban_sld_rounded_s_item, this, true)
