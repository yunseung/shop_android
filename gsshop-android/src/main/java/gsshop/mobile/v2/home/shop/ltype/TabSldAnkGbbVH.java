...
public class TabSldAnkGbbVH extends BaseViewHolderV2 {
     ...
     * @param itemView View
     */
    public TabSldAnkGbbVH(View itemView, String navigationId) {
        super(itemView);

        EventBus.getDefault().register(this);

        mRecyclerAnchor = itemView.findViewById(R.id.recycler_gschoice_category);
        ...
        public void onBindViewHolder(ItemViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    // 스크롤 위치 조정.
                    EventBus.getDefault().postSticky(new Events.ClickEventLtypeAnchor(mNavigationId, position, list.get(position).tabSeq, 80));
