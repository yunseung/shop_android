 ...
 */
@SuppressLint("NewApi")
public class SlVH extends BaseViewHolder {
    ...
    public void onBindViewHolder(final Context context, int position, ShopInfo info,
        ...
        int imageHeight = context.getResources()
                .getDimensionPixelSize(R.dimen.flexible_todays_hot_item_image_height);
        ...
        final InfinitePagerAdapter wrappedAdapter = new InfinitePagerAdapter(
                new TodaysHotAdapter(context, list, action, label));
        ...
        // indicator
        indicators.setIconTabListener(new TodaysHotBannerIndicatorListener(context, list.size()));
    ...
    /* 이미지 롤링 배너 indicator */
    private class TodaysHotBannerIndicatorListener implements IconTabListener {
         ...
         * @param count
         */
        public TodaysHotBannerIndicatorListener(Context context, int count) {
     ...
     */
    private static class TodaysHotAdapter extends PagerAdapter {
        ...
        public TodaysHotAdapter(Context context, List<SectionContentList> list, String action,
                                String label) {
            this.context = context;
