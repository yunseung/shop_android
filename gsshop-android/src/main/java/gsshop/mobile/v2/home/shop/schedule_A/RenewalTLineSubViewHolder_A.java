 ...
 * 편성표 부상품 V2
 */
public class RenewalTLineSubViewHolder_A extends RenewalPriceInfoBottomViewHolder {
	 ...
	 * @param view
	 */
	public RenewalTLineSubViewHolder_A(View view) {
		super(view);
