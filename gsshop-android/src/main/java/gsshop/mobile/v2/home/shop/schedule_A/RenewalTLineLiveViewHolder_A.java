 ...
 * 편성표 주상품(라이브) V2
 */
public class RenewalTLineLiveViewHolder_A extends RenewalTLinePrdViewHolder_A {

    /**
     * @param itemView
     */
    public RenewalTLineLiveViewHolder_A(View itemView) {
        super(itemView);
    ...
    public void onBindViewHolder(final Context context, final int position, final SchedulePrd data) {
        ...
        txt_broad_now.setVisibility(View.VISIBLE);
