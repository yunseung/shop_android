...
/**
 * gschoice 카테고리 B, 추후 sticky 해주는 홀더를 따로 모듈화하여 사용 하도록 수정!
 */
public class TabSldGbbVH extends BaseViewHolderV2 {
     ...
     * @param itemView View
     */
    public TabSldGbbVH(View itemView, String navigationId) {
        super(itemView);

        EventBus.getDefault().register(this);

        recycler = itemView.findViewById(R.id.recycler_gschoice_category_b);
...
//            @Override
//            public void run() {
//                mLayoutManager.scrollToPositionWithOffset(fvPosition, offSet);
//            }
//        }, 100);
//    }
        ...
        public void onBindViewHolder(ItemViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    setItem(context, holder, list.get(position));
...
//                    scrollToCenter(v, position);
            ...
            if (selectedItemIndex == position) {
                setSelectedItem(context, holder, list.get(position));
            } else {
    ...
    private void setItem(Context context, ItemViewHolder holder, ModuleList item) {
        ...
        setSelectedItem(context, holder, item);
    }

    private void setSelectedItem(Context context, ItemViewHolder holder, ModuleList item) {
