 ...
 *
 */
public class ShortbangBannerReadmoreViewHolder extends BaseViewHolder {
     ...
     * @param itemView
     */
    public ShortbangBannerReadmoreViewHolder(View itemView) {
        super(itemView);
        ...
        if(info.contents.get(position).sectionContent.isShow){
            ...
            read_more_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    EventBus.getDefault().post(new Events.FlexibleEvent.ShortbangReadmore());
                }
            });
        }else{
