 ...
 * 추천딜 리스트 어뎁터.
 */
public class PrdCSqAdapter extends RecyclerView.Adapter<PrdCSqAdapter.RecommendViewHolder> {
     ...
     * @param label
     */
    public PrdCSqAdapter(Context context, List<SectionContentList> subProductList, String action, String label, String naviId) {
     ...
     * @param label
     */
    public PrdCSqAdapter(Context context, List<SectionContentList> subProductList, int length, String action, String label, String naviId) {
