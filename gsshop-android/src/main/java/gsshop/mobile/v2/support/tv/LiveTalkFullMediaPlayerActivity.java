 ...
 */
public class LiveTalkFullMediaPlayerActivity extends AbstractBaseActivity implements OnMediaPlayerListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_livetalk_fullscreen);
