 ...
 * 앱티마이저 초기화 및 실험요소 정리
 */
public class ApptimizeIMGMSCommand extends ApptimizeBaseCommand {
    /**
    ...
    public void execute(Activity activity, CommandChain chain) {
        ...
        ThreadUtils.INSTANCE.runInBackground(() -> apptimizeBase(activity, chain, ApptimizeExpManager.IMGMS));
    }
}
