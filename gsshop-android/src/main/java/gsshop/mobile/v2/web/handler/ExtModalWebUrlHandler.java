 ...
 *
 * ex) toapp://extmodal?title=xxx{@literal &}url=xxx
 */
public class ExtModalWebUrlHandler implements WebUrlHandler {
    ...
    public boolean match(String url) {
        return url.startsWith(ServerUrls.APP.EXT_MODAL_WEB);
    }
}
