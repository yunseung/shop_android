 ...
 *
 */
public class InterestRecommendationAdapter extends RecyclerView.Adapter<InterestRecommendationAdapter.RecommendViewHolder> {
	 ...
	 * @param label
	 */
	public InterestRecommendationAdapter(Context context, ArrayList<CateContentList> subProductList, String action, String label) {
		mContext = context;
	...
	public RecommendViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
		View itemView = LayoutInflater.from(viewGroup.getContext())
				.inflate(R.layout.interest_recommendation_item, viewGroup, false);
